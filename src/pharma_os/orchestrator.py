...
from pharma_os.schemas import ClinicalTrialIntelligenceInput, DueDiligenceInput, WorkflowRun
...
class Orchestrator:
    ...
    def run(
        self,
        workflow: str,
        input_data: ClinicalTrialIntelligenceInput | DueDiligenceInput | None = None,
    ) -> object:
